...
## Emitted when user clicks a tile in the candidate list.
...
## Enable / disable (gray-out) the entire column.
func set_enabled(enabled: bool) -> void:
	_set_enabled(enabled)


## Highlight a tile with a blue border.
...
## Set [tile_name] to full color or grayscale based on [connected].
